...
<head>
    ...
    <link href="../vendor/css/font-awesome.css" rel="stylesheet" />
     <!-- MORRIS CHART STYLES-->
    <link href="../vendor/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
        <!-- CUSTOM STYLES-->
                            ...
                            <ul class="chat-box">
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                        <img src="../vendor/img/1.png" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body">                                        
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                        ...
                                        <img src="../vendor/img/2.png" alt="User" class="img-circle" />
                                    </span>
                                ...
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                         <img src="../vendor/img/3.png" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                         <img src="../vendor/img/4.png" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
...
<span class="label label-danger">Danger</span>
    ...
    <script src="../vendor/js/jquery.metisMenu.js"></script>
     ...
     <script src="../vendor/js/morris/raphael-2.1.0.min.js"></script>
    <script src="../vendor/js/morris/morris.js"></script>
      <!-- CUSTOM SCRIPTS -->

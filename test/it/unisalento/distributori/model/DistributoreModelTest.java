...
public class DistributoreModelTest {
	...
	public void testSetCivico() throws Exception {
		...
		assertEquals((Integer)10, distributore.getCivico());
	}
	...
	public void testSetNumPosti() throws Exception {
		...
		assertEquals((Integer)10, distributore.getNumPosti());
	}
	...
	@Test
	public void testSetStato_String() throws Exception {
		distributore.setStato_String("Online");
		assertEquals("Online", distributore.getStato_String());
	}
